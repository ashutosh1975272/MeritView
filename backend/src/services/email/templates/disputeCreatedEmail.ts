...
export function disputeCreatedEmail(disputeId: string, title: string): string {
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
        <tr>
          <td style="background:linear-gradient(135deg,#1e3a5f 0%,#2d5a8e 100%);padding:32px 40px;text-align:center">
            ...
            <h1 style="color:#ffffff;font-size:24px;margin:16px 0 0 0;font-weight:600">Dispute Created</h1>
          </td>
        </tr>
        <tr><td style="padding:40px">
          <p style="color:#334155;font-size:16px;line-height:1.6;margin:0 0 16px 0">Your dispute has been created successfully.</p>
          <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc;border-radius:8px;border:1px solid #e2e8f0;margin-bottom:24px">
            <tr><td style="padding:16px">
              <p style="color:#64748b;font-size:13px;margin:0 0 4px 0;text-transform:uppercase;letter-spacing:0.5px">Dispute</p>
              <p style="color:#1e293b;font-size:18px;font-weight:600;margin:0">${title}</p>
            </td></tr>
          </table>
          <p style="color:#334155;font-size:15px;line-height:1.6;margin:0 0 24px 0">Next steps: Prepare your brief and submit it for AI analysis. The process takes about 5-10 minutes.</p>
          <table cellpadding="0" cellspacing="0" style="margin:0 auto">
            <tr><td style="background-color:#1e3a5f;border-radius:8px;padding:12px 32px">
              <a href="${disputeUrl}" style="color:#ffffff;font-size:16px;font-weight:600;text-decoration:none;display:inline-block">View Dispute</a>
            </td></tr>
          </table>
        </td></tr>
