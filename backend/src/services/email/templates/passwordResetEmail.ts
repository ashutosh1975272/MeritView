...
export function passwordResetEmail(token: string): string {
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
        <tr>
          <td style="background:linear-gradient(135deg,#1e3a5f 0%,#2d5a8e 100%);padding:32px 40px;text-align:center">
            ...
            <h1 style="color:#ffffff;font-size:24px;margin:16px 0 0 0;font-weight:600">Reset Your Password</h1>
          </td>
        </tr>
        <tr><td style="padding:40px">
          <p style="color:#334155;font-size:16px;line-height:1.6;margin:0 0 24px 0">We received a request to reset the password for your MeritView account. Click the button below to set a new password.</p>
          <table cellpadding="0" cellspacing="0" style="margin:0 auto 24px auto">
            <tr><td style="background-color:#1e3a5f;border-radius:8px;padding:12px 32px">
              <a href="${resetUrl}" style="color:#ffffff;font-size:16px;font-weight:600;text-decoration:none;display:inline-block">Reset Password</a>
            </td></tr>
          </table>
          <p style="color:#64748b;font-size:14px;line-height:1.5;margin:0 0 8px 0">Or copy this link into your browser:</p>
          <p style="color:#1e3a5f;font-size:13px;line-height:1.5;margin:0;word-break:break-all;background-color:#f8fafc;padding:12px;border-radius:6px;border:1px solid #e2e8f0">${resetUrl}</p>
          <p style="color:#94a3b8;font-size:13px;margin:24px 0 0 0">This link expires in 1 hour. If you didn't request a password reset, you can safely ignore this email.</p>
        </td></tr>
