...
export function paymentFailedEmail(error: string): string {
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
        <tr>
          <td style="background:linear-gradient(135deg,#1e3a5f 0%,#2d5a8e 100%);padding:32px 40px;text-align:center">
            ...
            <h1 style="color:#ffffff;font-size:24px;margin:16px 0 0 0;font-weight:600">Payment Failed</h1>
          </td>
        </tr>
        <tr><td style="padding:40px">
          <p style="color:#334155;font-size:16px;line-height:1.6;margin:0 0 16px 0">We were unable to process your payment. Please review the details below and try again.</p>
          <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#fef2f2;border:1px solid #fecaca;border-radius:8px;margin-bottom:24px">
            <tr><td style="padding:16px">
              <p style="color:#dc2626;font-size:13px;margin:0 0 4px 0;font-weight:600">Error Details</p>
              <p style="color:#991b1b;font-size:14px;margin:0">${error}</p>
            </td></tr>
          </table>
          <p style="color:#334155;font-size:15px;line-height:1.6;margin:0 0 24px 0">Your dispute is still saved and your brief is secure. You can retry the payment at any time.</p>
          <table cellpadding="0" cellspacing="0" style="margin:0 auto">
            <tr><td style="background-color:#1e3a5f;border-radius:8px;padding:12px 32px">
              <a href="${appUrl}/dashboard/disputes" style="color:#ffffff;font-size:16px;font-weight:600;text-decoration:none;display:inline-block">Retry Payment</a>
            </td></tr>
          </table>
        </td></tr>
